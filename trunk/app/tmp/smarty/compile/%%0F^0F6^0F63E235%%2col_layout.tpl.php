<?php /* Smarty version 2.6.19, created on 2008-07-02 13:40:01
         compiled from /var/www/localhost/htdocs/ztracker/app/views/layouts/2col_layout.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', '/var/www/localhost/htdocs/ztracker/app/views/layouts/2col_layout.tpl', 5, false),)), $this); ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN"
   "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
<head>
<title><?php echo ((is_array($_tmp=@$this->_tpl_vars['pageTitle'])) ? $this->_run_mod_handler('default', true, $_tmp, 'untitled') : smarty_modifier_default($_tmp, 'untitled')); ?>
 - Бумер трекер</title>
...
unset($_smarty_tpl_vars);
 ?>
		...
		<div id="nav"> <a id="navigation" name="navigation"></a>
			...
			<div id="nav_main">
            <?php echo $this->_tpl_vars['menu']->display(); ?>
